...
const Login = () => {
  ...
  // submit the form: this is the format we'll use for the form
  const submitHandler = (e) => {
    e.preventDefault()
    dispatch(login(email, password))        //  it goes to the backend, if the email and password matches, then it returns with the user data
  }
