...
export const register = (userData) => async (dispatch) => {
  //  userData will come from, register.jsx form; when we submit that form there, it will send us the userData and then we will do post request, to set
  try {
    dispatch({
...
export const logout = () => async (dispatch) => {
  try {
    ...
    dispatch({
      type: CLEAR_CART,                       //  clear cart when log out
    })
  } catch (error) {
    dispatch({
      type: LOGOUT_FAIL,
